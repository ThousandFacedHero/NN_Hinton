...
% <hidden_state> is a (possibly but not necessarily binary) 
%   matrix of size <number of hidden units> 
%   by <number of configurations that we're handling in parallel>.
...
%   respect to the model parameters. Thus, the returned value is of the 
%   same shape as the model parameters, which by the way are not provided 
%   to this function. Notice that we're talking about the mean over data 
%   cases (as opposed to the sum over data cases).

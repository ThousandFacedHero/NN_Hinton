function visible_probability = ...
  hidden_state_to_visible_probabilities(rbm_w, hidden_state)
...
%   by <number of configurations that we're handling in parallel>.
% This takes in the (binary) states of the hidden units, 
%   and returns the activation probabilities of the visible units,
